...
namespace KoenZomers.UniFi.Api.Responses
{
    ...
    public class ClientSession : BaseResponse
    {
        ...
        /// <summary>
        ///     Seconds since January 1, 1970 when the client started this session. Use SessionStartedAt for a DateTime
        ...
        {
            get => SessionStartedAtRaw.HasValue ? (DateTime?) new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc).AddSeconds(SessionStartedAtRaw.Value).ToLocalTime() : null;
        ...
        /// <summary>
        ///     DateTime when the client ended this session. If this DateTime is close to the current date and time, it means that
        ...
        /// </summary>
        public TimeSpan? SessionDurationTimeSpan => SessionDuration.HasValue ? (TimeSpan?) TimeSpan.FromSeconds(SessionDuration.Value) : null;
